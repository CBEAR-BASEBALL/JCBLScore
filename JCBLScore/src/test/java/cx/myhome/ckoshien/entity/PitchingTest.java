...
public class PitchingTest extends S2TestCase {
    ...
    public void testFindById() throws Exception {
        jdbcManager.from(Pitching.class).id(1).getSingleResult();
    }
    ...
    public void testLeftOuterJoin_player() throws Exception {
        jdbcManager.from(Pitching.class).leftOuterJoin(player()).id(1).getSingleResult();
    }
    ...
    public void testLeftOuterJoin_game() throws Exception {
        jdbcManager.from(Pitching.class).leftOuterJoin(game()).id(1).getSingleResult();
    }
}